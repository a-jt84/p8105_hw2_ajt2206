...
* Total weight of trash collected by Professor Trash Wheel in tons. `r filter(triple_trash_df, wheel== "Professor Trash Wheel") |> pull(weight_tons) |> sum()`

* Total number of cigarette butts collected by Gwynnda is July of 2021: `r filter(triple_trash_df, wheel== "Gwynnda Trash Wheel", month == "July", year == "2021") |> pull(cigarette_butts) |> sum()`
