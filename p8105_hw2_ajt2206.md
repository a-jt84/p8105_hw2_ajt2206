...
- This dataset provides data from May 2014 to August 2018 on the trash
  ...
  collected 216.26tons of trash as of September 2023. Moreover, Gwynnda
...
**Exporting the result as a CSV** write.csv(mci_combined_df, file =
“data/mci_combined_df.csv” , row.names = FALSE)
