...
women_df=
  mci_baseline_df[mci_baseline_df$sex == "Female", ]

women_carrier_df=
  women_df[women_df$apoe4 == "Carrier", ]
```
**Description of the import process and dataset**

`r nrow(mci_baseline_df)` participants met the inclusion criteria of the study and were included in the data. One participant was excluded as they had mci at Baseline. Of the `r nrow(mci_baseline_df)` participants, `r sum((mci_baseline_df$age_at_onset != "."))`went on to develop mci. The average baseline age is `r mean(mci_baseline_df$current_age)` years old. `r nrow(women_carrier_df)/nrow(women_df)* 100`% of the women in the study are APOE4 carriers. 
